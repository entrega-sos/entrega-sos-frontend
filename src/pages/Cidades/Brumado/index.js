...
export default function Brumado() {
  ...
  useEffect(() => {
    async function loadNegocios() {
      ...
      const negocios = response.data.Brumado;
  ...
  async function handleStores(negocioName) {
    ...
    const filteredNegocios = negocios.filter(function filterData(negocio) {
      return (
        negocio.cidade === 'Brumado' && negocio.tipo_negocio === negocioName
      );
    });
                    ...
                    <div>
                      ...
                      <div className="pagamento-box">
                        {pagamento !== null ? (
                          <>
                            {pagamento.map(p => (
                              <p key={p.toString()} className="pagamento">
                                {p}
                              </p>
                            ))}
                          </>
